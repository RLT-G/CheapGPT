...
answer_texts = {
    'ru': {
        'main': """
ChastGPT mini — полный аналог ChatGPT в Telegram, но в 6 раз дешевле!
...
➖➖➖➖➖➖➖➖➖➖➖
🎉 Вы пригласили <b>{}</b> новых пользователей.
💵 и получили за их расходы <b>{}</b> ₽!

📋 Условия: 
За каждого приглашенного пользователя вы получаете <b>10%</b> от всех его расходов </b>навсегда</b>!
...
""",
        ...
        'token': """
⚖️ <b>Отличие от ChatGPT</b>
➖➖➖➖➖➖➖➖➖➖➖
ChastGPT mini предлагает те же функции и ответы, что и ChatGPT, но не за $20 в месяц, а всего за $2.49 при годовой подписке или $3.49 при месячной. 

💸 Таким образом, цена подписки на полгода в бот ChastGPT mini равна цене подписки на месяц в ChatGPT! 🚀
""",
        'settings_ai': """
...
""",
        'usage_ai': """
⚖️ <b>Отличие от других ботов</b>
➖➖➖➖➖➖➖➖➖➖➖
<b>Базовое отличие</b> нашего CheapGPT mini от других ботов — они "оптимизируют" запросы, урезая их, что ухудшает качество ответов. За счет такой "оптимизации" другие боты могут предлагать низкую цену подписки на GPT-4o.
💰 В действительности же, себестоимость одного пользователя с "чистыми" запросами к GPT-4o составляет примерно <b>7$</b> в месяц.
💡 <b>Именно из-за урезания запросов ответы от других ботов будет хуже, чем ответы от оригинального ChatGPT.</b>

📊 В тестах на производительность GPT-4o mini уступает GPT-4o в среднем всего на <b>4%</b>. А оптимизация запросов к GPT-4o часто более значительно ухудшает качество ответа.
...
✨ В итоге, CheapGPT mini использует GPT-4o mini, сохраняя при этом весь функционал GPT-4o, включая работу с ссылками, файлами, изображениями и голосовыми командами, по минимальной цене.
""",
        'actual_ai': """
