...
➖➖➖➖➖➖➖➖➖➖➖
Базовое отличие нашего CheapGPT от других ботов — они "оптимизируют" запросы, урезая их, что ухудшает качество ответов.  За счет такой "оптимизации" другие боты могут предлагать подписку на GPT-4o по цене ниже 8$ в месяц. 
...
btn_texts = {
    'ru': {
        ...
        'payment_1': 'Ежемесячная $3.49',
        'payment_2': 'Годовая $29.99 (-40%)',
