...
""",
        'usage_ai': """
<b>Базовое отличие</b> нашего ChastGPT mini от других ботов — они "оптимизируют" запросы, урезая их, что ухудшает качество ответов.  За счет такой "оптимизации" другие боты могут предлагать подписку на GPT-4o по цене ниже 8$ в месяц. 
...
✨ В итоге, ChastGPT mini использует GPT-4o mini, сохраняя при этом весь функционал GPT-4o, включая обработку ссылок, файлов, изображений и голосовых команд, но по минимальной цене.
""",
        'actual_ai': """
